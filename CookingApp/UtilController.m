...
- (UIView *)buildCanvasWithX:(float)x withY:(float)y withWidth:(float)width withHeight:(float)height
{
    UIView *canvas = [[UIView alloc] initWithFrame:CGRectMake(x,y,width,height)];
